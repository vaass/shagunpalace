...
$LANG['c_name'] = "Enter the Customer's Name:";//1
$LANG['c_father_name'] = "Enter the Customer's Father's Name:";//1
$LANG['c_email'] = "Enter Email Address:";//1
$LANG['c_address'] = "Enter the Customer's Address:";//1
$LANG['c_hno'] = "Enter House Number:";//1
$LANG['c_po'] = "Enter Post Office:";//1
$LANG['c_city'] = "Enter City:";//1
$LANG['c_state'] = "Enter the State:";//1
$LANG['c_country'] = "Enter The Country:";//1
$LANG['c_c_no'] = "Enter Customer's Contact No. :";//1
$LANG['c_c_no1'] = "Enter Customer's Contact No.2:";//1
$LANG['c_c_no2'] = "Enter Customer's Contact No.3:";//1
$LANG['purpose'] = "Purpose:";//1
$LANG['booking_d'] = "Enter Booking Date:";//1
$LANG['time_d'] = "Enter Timings:";//1
$LANG['gathering_d'] = "Gathering:";//1
$LANG['waiters_a'] = "Waiters Class A:";//1
$LANG['waiters_b'] = "Waiters Class B:";//1
$LANG['flower_d'] = "Flower Decoration:";//1
$LANG['e_charge'] = "Extra Charges:";//1
$LANG['anand_k'] = "Anand Kharaj:";//1


$LANG['customer_short'] = "Cust";//1
$LANG['customers'] = "Customers";//1
$LANG['new_reservation'] = "Create New Reservation";//1
$LANG['check_a'] = "Check Availability";//1
$LANG['search_dt'] = "Get Booking Details";//1
$LANG['enter_d'] = "Enter Booking Date : ";//1
$LANG['enter_time'] = "Enter Timing : ";//1
$LANG['enter_month'] = "Enter Booking Month : ";//1
$LANG['by_date'] = "Search By Date";//1
$LANG['by_month'] = "Search By Month";//1
$LANG['by_name'] = "Search By Name";//1
$LANG['check_availability'] = "Check Availability";//1
...
$LANG['shagun_palace'] = "Shagun Palace Billing";//1
$LANG['simple_invoices_powered_by'] = "Powered by Vaass Infotech";//1
$LANG['powered_by'] = "VaaSS Infotech";//1
$LANG['start_date'] = "Start date (YYYY-MM-DD)";
$LANG['start_date_short'] = "Start date";
$LANG['start_reservation'] = "New Reservation";//1
$LANG['search'] = "Search";//1
$LANG['trash'] = "Trash";//1
$LANG['trash_f'] = "View Trash Items";//1
$LANG['booking'] = "View Booking";//1
$LANG['by_date_book'] = "View Booking By Date";//1
$LANG['by_month_book'] = "View Booking By Month";//1
$LANG['by_all_book'] = "View All Bookings";//1
...
$LANG['copy_right'] = "© 2011 Shagun Palace, All rights reserved. Powered By  ";
